...
winget install -e -h --id Microsoft.AzureCosmosEmulator --force --accept-source-agreements
winget install -e -h --id Microsoft.AzureStorageEmulator --force --accept-source-agreements

# Utilities
winget install -e -h --id 7zip.7zip --force --accept-source-agreements
